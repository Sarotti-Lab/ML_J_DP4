...
- The NMR data must be assigned (know which shift corresponds to which nuclei). Using MARTA NO ESTAS LEYENDO unassigned or misassigned NMR data can lead to erroneous results.
